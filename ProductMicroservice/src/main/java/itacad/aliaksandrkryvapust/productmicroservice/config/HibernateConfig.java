package itacad.aliaksandrkryvapust.productmicroservice.config;
...
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("itacad.aliaksandrkryvapust.productmicroservice");
        ...
        jpaProperties.put("hibernate.physical_naming_strategy", "itacad.aliaksandrkryvapust.productmicroservice.config.CustomNamingStrategy");
